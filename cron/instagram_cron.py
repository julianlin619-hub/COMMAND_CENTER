...
def main():
    ...
    try:
        # Refresh credentials before making API calls. If this fails, abort
        # immediately — proceeding with invalid tokens wastes time and may
        # trigger rate limits or account lockouts on the platform side.
        try:
